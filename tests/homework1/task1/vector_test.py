...
class VectorTestCase(unittest.TestCase):
    ...
    def test_dot_product_same_dimensions_2(self):
        vector_1 = Vector(1.0, 3.0, 101.0, 3.0)
        vector_2 = Vector(9.0, 3.0, 4.0, 2.0)

        self.assertAlmostEqual(vector_1.dot(vector_2), 428.0)
